...
public class IDDecisionTreeEvaluationTest extends NetworkEvaluationInferenceTest {
    ...
    @Test
    public void testIDOnlyUtility() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("only-utility", 10.0);
    }
    
    @Tag(TestSpeed.MEDIUM)
    @Test
    public void testIDOneChance() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("one-chance", 83.7);
    }
    
    @Tag(TestSpeed.MEDIUM)
    @Test
    public void testIDOneDecision() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("one-decision", 87.4, "D");
    }
    
    @Tag(TestSpeed.MEDIUM)
    @Test
    public void testIDNoKnowledge() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("no-knowledge", 9.16, "D");
    }
    
    @Tag(TestSpeed.MEDIUM)
    @Test
    public void testIDPerfectKnowledge() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("perfect-knowledge", 9.72, "D", "A");
    }
    
    @Tag(TestSpeed.MEDIUM)
    @Test
    public void testIDTest2Therapies() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
        testNetworkEvaluation("test-2therapies", 9.39366, "Test", "Therapy");
    }
    
    @Test
    public void testIDOnlyDecisionNoUtility() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
    ...
    @Test
    public void testIDTest2Therapies_Tree() throws NotEvaluableNetworkException, ParserException, URISyntaxException, FileNotFoundException {
